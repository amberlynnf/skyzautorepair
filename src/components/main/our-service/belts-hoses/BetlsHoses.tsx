...
import classes from "./BeltsHoses.module.css";
import AOS from "aos";
import "aos/dist/aos.css";
import Header from "../../../header/Header";
import Footer from "../../../footer/Footer";

interface BeltsHosesProps {
  id?: string;
}

export function BeltsHoses({}: BeltsHosesProps) {
  useEffect(() => {
        ...
        <Container size="xl" className={classes.heroInner}>
          <div className={classes.heroContent}>
            ...
            <Text className={classes.heroSubtitle} data-aos="fade-up" data-aos-delay="150">
              We Can Maintain Your Vehicles. Belts & Hoses In Houston, TX.
            </Text>
